                            ...
                            if (field.type === "select") {
                                return (
                                    <div>
                                        ...
                                        <select {...register(field.name, { required: field.required })} id={field.name} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
