...
const AuthSection = () => {
    ...
    return (
        <div id='authScroll' className="pt-6 text-black absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 bg-white w-96 max-h-[90vh] border rounded-md p-5 shadow-2xl overflow-y-auto">
