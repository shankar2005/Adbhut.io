    ...
    return (
        <div className='bg-white rounded-lg shadow-lg'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='p-4'>
                ...
                <div className="mb-4">
                    <label for="profile_image" className="block mb-2 text-sm font-medium text-gray-900">Profile image</label>
                ...
                <div className="mb-4">
                    <label for="location" className="block mb-2 text-sm font-medium text-gray-900">Select country</label>
                ...
                <div className="mb-4">
                    <label for="language" className="block mb-2 text-sm font-medium text-gray-900">Select language</label>
                    <Controller
                        control={control}
                        name='languages'
                        id='language'
                ...
                <div className="mb-4">
                    <label for="skill" className="block mb-2 text-sm font-medium text-gray-900">Select skill</label>
                    <Controller
                        control={control}
                        name='skill'
                        id='skill'
                ...
                <div className="mb-4">
                    <label for="genre" className="block mb-2 text-sm font-medium text-gray-900">Select genre</label>
                    <Controller
                        control={control}
                        name='genre'
                        id='genre'
                ...
                <div className="mb-4">
                    <label for="intro" className="block mb-2 text-sm font-medium text-gray-900">Intro</label>
                ...
                <div className="mb-4">
                    <label for="best_work_link" className="block mb-2 text-sm font-medium text-gray-900">Best Work Link</label>
                ...
                <div className="mb-4">
                    <label for="work_link_2" className="block mb-2 text-sm font-medium text-gray-900">Work Link 2</label>
                ...
                <div className="mb-4">
                    <label for="work_link_3" className="block mb-2 text-sm font-medium text-gray-900">Work Link 3</label>
                ...
                <div className="mb-4">
                    <label for="name" className="block mb-2 text-sm font-medium text-gray-900">Social Link</label>
                ...
                <div className='grid grid-cols-2 gap-2'>
                    <div className="mb-4">
                        <label for="professional_rating" className="block mb-2 text-sm font-medium text-gray-900">Professional Rating</label>
                    ...
                    <div className="mb-4">
                        <label for="attitude_rating" className="block mb-2 text-sm font-medium text-gray-900">Attitude Rating</label>
                ...
                <div className="mb-4">
                    <label for="budget_range" className="block mb-2 text-sm font-medium text-gray-900">Budget range</label>
                ...
                <div className="mb-4">
                    <label for="budget_idea" className="block mb-2 text-sm font-medium text-gray-900">Budget idea</label>
                ...
                <div className="mb-4">
                    <label for="am_notes" className="block mb-2 text-sm font-medium text-gray-900">Artist manager notes</label>
                ...
                <div className="mb-4">
                    <label for="pm_notes" className="block mb-2 text-sm font-medium text-gray-900">Production manager notes</label>
