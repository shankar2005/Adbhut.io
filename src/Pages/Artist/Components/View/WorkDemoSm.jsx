...
const WorkDemoSm = ({ demo_type, demo_link }) => {
    ...
    switch (demo_type) {
        ...
        case "Imdb":
            content = (
                <a href={demo_link} className='hover:underline bg-black border rounded-lg aspect-square flex flex-col items-center justify-center text-center' target="_blank">
                    <img className="mx-auto w-20" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/IMDB_Logo_2016.svg/575px-IMDB_Logo_2016.svg.png" alt="" />
                    <p className='text-sm font-medium text-white flex justify-center gap-2 mt-4'>Open in Imdb <BsBoxArrowUpRight /></p>
                </a>
            )
            break;
        case "Drop Box":
            content = (
                <a href={demo_link} className='hover:underline bg-gray-100 rounded-lg aspect-square flex flex-col items-center justify-center text-center' target="_blank">
                    <img className="mx-auto w-20" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Dropbox_Icon.svg/1101px-Dropbox_Icon.svg.png" alt="" />
                    <p className='text-sm selection:font-medium text-blue-700 flex justify-center gap-2 mt-2'>Open in DropBox <BsBoxArrowUpRight /></p>
                </a>
            )
            break;
        case "Spotify":
