...
const WorkDemo = ({ demo_type, demo_link }) => {
    ...
    switch (demo_type) {
        ...
        case "Instagram":
            content = (
                <a target="_blank" href={demo_link}>
                    <div className="h-80 border flex flex-col gap-3 items-center justify-center">
        ...
        case "Behance":
            content = (
                <a href={demo_link} className='hover:underline block bg-black py-16 border rounded-lg' target="_blank">
        ...
        case "Imdb":
            content = (
                <a href={demo_link} className='hover:underline block bg-black border py-20 rounded-lg' target="_blank">
